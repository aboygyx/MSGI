...
class Dataset_Custom(Dataset): 
    ...
    def __read_data__(self):
        ...
        num_train = int(len(df_raw)* 0.8)  # 训练集比例
        num_test = int(len(df_raw)* 0.0993) # 测试集比例
...
class Dataset_Pred(Dataset):
    ...
    def __read_data__(self):
        ...
        #     self.data_y = df_data.values[border1:border2]
        # else:
        #     self.data_y = data[border2-self.label_len-self.pred_len:border2]
        # self.data_stamp = data_stamp
    ...
    def __getitem__(self, index):
        ...
        if self.inverse:
            ...
            # seq_y = self.data_y[r_begin:r_end] #NEW STUFF
